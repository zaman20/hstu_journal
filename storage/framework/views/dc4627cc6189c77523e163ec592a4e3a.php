        ...
        <div class="middle-part full-width">
            ...
            <div class="form-area border border-primary border-2">
                ...
                <div class="form-box" id="page1">
                    ...
                    <a data-id="1"  data-author="<?php echo e(session('id')); ?>" class="next mt-2 btn btn-secondary">Next</a>
                </div>
                ...
                <div class="form-box" class="form-control" id="page2">
                    ...
                    <a data-id="2"  data-author="<?php echo e(session('id')); ?>" class="next btn btn-secondary">Next</a>
                </div>
                ...
                <div class="form-box" id="page7">
                    <h2>Attach Files </h2>
                        ...
                        <input type="hidden" value="<?php echo e(session('id')); ?>" name="author">
