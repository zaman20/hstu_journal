...
<ul>
    ...
    <li class="{{ Request::routeIs('author2') ? 'menuactive' : '' }}">
        <a href="">Submissions Need Revision</a></li>
    ...
    <li class="{{ Request::routeIs('author5') ? 'menuactive' : '' }}">
        <a href="">Submissions Being Processed</a></li>
    ...
    <li class="{{ Request::routeIs('editor4') ? 'menuactive' : '' }}">>
        <a href="{{url('/incomplete-submission')}}">Submissions in Revission</a></li>
